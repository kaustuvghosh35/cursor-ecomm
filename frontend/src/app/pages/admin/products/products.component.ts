      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <div class="mb-6 flex items-center justify-between">
          <div class="relative">
            <input
              ...
              class="pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-64"
            />
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="h-10 w-10 flex-shrink-0">
                      <img class="h-10 w-10 object-cover rounded-md" src="https://via.placeholder.com/40" alt="Product" />
                    </div>
                    <div class="ml-4">
                      <div class="text-sm font-medium text-gray-900">Smartphone X</div>
                      <div class="text-sm text-gray-500">SKU: SM-X-1234</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">25 in stock</span>
                </td>
              ...
              <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-sm text-gray-500">SKU: LP-4567</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">$1,299.99</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">3 in stock</span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <a href="#" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                  <a href="#" class="text-red-600 hover:text-red-900">Delete</a>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-sm text-gray-500">SKU: WH-7890</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="flex justify-between items-center mt-6">
          <div class="text-sm text-gray-500">
            Showing <span class="font-medium">1</span> to <span class="font-medium">10</span> of <span class="font-medium">56</span> products
          </div>
