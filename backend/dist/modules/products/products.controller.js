...
let ProductsController = class ProductsController {
    ...
    findAll(page, limit, category, minPrice, maxPrice, sort) {
        return this.productsService.findAll(page, limit, category, minPrice, maxPrice, sort);
    }
    findOne(id) {
